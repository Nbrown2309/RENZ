...
def submit_property():
    if request.method == 'POST':
        ...
        new_property = Property(location=location, title=title, salesdate=salesdate,
                        subtitle=subtitle, salestype=salestype, property_detail=property_detail,
                        description=description, price_range_low=pricerange_low,
                        price_range_medium=pricerange_medium, price_range_high=pricerange_high,
                        capital_value=capital_value, agent_name=agent_name,
